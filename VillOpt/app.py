...
def generate_invoices(filepath):
    ...
    for _, row in df.iterrows():
        ...
        c.drawString(margin, height - margin - 10, "The Village Optician Ltd")
        c.setFillColor(colors.black)
        c.setFont("Helvetica", 10)
        c.drawString(margin, height - margin - 30, "MICHAEL GREENBERG, BSc (Hons), MCOptom.")
        c.setFont("Helvetica-Oblique", 9)
        c.drawString(margin, height - margin - 45, "OPHTHALMIC OPTICIAN & CONTACT LENS PRACTITIONER")
